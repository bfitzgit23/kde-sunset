...
# @ECLASS: sunset-cmake-multilib.eclass
# @MAINTAINER:
...
sunset-cmake-multilib_src_configure() {
	local _cmake_args=( "${@}" )
...
sunset-cmake-multilib_src_compile() {
	local _cmake_args=( "${@}" )
...
sunset-cmake-multilib_src_test() {
	local _cmake_args=( "${@}" )
...
sunset-cmake-multilib_src_install() {
	local _cmake_args=( "${@}" )
